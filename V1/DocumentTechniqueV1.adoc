...
* DC des classes controlleurs de dialogue : 

image::../V1/DC/controlDC.png[titre="Diagramme de classe control"]

* DC des classes outils 

image::../V1/DC/toolsDC.png[titre="Diagramme de classe tools"]
...
image::../V1/DC/dataDC.png[titre="Diagramme de classe data"]

* DC des classes d'accés physique à la BD 

image::../V1/DC/ormDC.png[titre="Diagramme de classe orm"]
