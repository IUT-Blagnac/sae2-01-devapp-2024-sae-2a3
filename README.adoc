...
| 2       | Chef d’Agence | Client                    | Désactiver client     | D        |       |          |
...
|       | Gantt V2 prévu | https://github.com/IUT-Blagnac/sae2-01-devapp-2024-sae-2a3/blob/4fe8b7097ae01b2377c41310ddbd49ba78448d9d/V1/Gantt_V2_pr%C3%A9vu.pdf[lien]    | 
