...
Dans le cadre de notre cours de développement d'application (SAE S2.01) et de gestion de projet (SAE S2.05), nous nous lançons dans un projet passionnant. Notre objectif est de créer une nouvelle application pour la banque DailyBank. Cette application remplacera plusieurs outils obsolètes actuellement utilisés par la banque pour gérer les comptes clients.
