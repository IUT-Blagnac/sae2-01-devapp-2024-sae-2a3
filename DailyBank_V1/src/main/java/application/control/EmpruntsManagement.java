...
import application.view.EmpruntsManagementViewController;
...
public class EmpruntsManagement {
	...
	private EmpruntsManagementViewController emViewController;
	private Client clientDuCompte;
	private CompteCourant compteConcerne;

	public EmpruntsManagement(Stage _parentStage, DailyBankState _dbstate, Client client, CompteCourant compte) {
		...
		try {
			FXMLLoader loader = new FXMLLoader(
					OperationsManagementViewController.class.getResource("empruntsmanagement.fxml"));
			...
			this.emViewController.initContext(this.emStage, this, _dbstate, client, this.compteConcerne);
	...
	public Operation simulerVirement() {

		OperationEditorPane oep = new OperationEditorPane(this.emStage, this.dailyBankState);
